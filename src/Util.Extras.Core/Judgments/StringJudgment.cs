...
namespace Util.Extras.Judgments
{
    /// <summary>
    ...
    public static class StringJudgment
    {
        ...
        /// WebUrl 正则表达式
        /// </summary>
        private static readonly Regex WebUrlExpressionSchema = new Regex(
            @"(http|https)://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?",
        ...
        /// Email 正则表达式
        /// </summary>
        private static readonly Regex EmailExpressionSchema = new Regex(
