...
namespace Util.Extras.Helpers
{
    ...
    public static class Check
    {
        ...
        {
            Require<ArgumentNullException>(value != null, string.Format(CoreRes.ParameterCheck_NotNull, paramName));
            return value;
        }
        ...
        public static void NotNullOrEmpty(string value, string paramName)
        {
            ...
            Require<ArgumentException>(!string.IsNullOrEmpty(value),
                string.Format(CoreRes.ParameterCheck_NotNullOrEmpty_String, paramName));
        }
        ...
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="ArgumentNullException"></exception>
        public static void NotEmpty(Guid value, string paramName) => Require<ArgumentException>(value != Guid.Empty,
            string.Format(CoreRes.ParameterCheck_NotEmpty_Guid, paramName));
        ...
        public static void NotNullOrEmpty<T>(IEnumerable<T> collection, string paramName)
        {
            ...
            Require<ArgumentException>(enumerable.Any(),
                string.Format(CoreRes.ParameterCheck_NotNullOrEmpty_Collection, paramName));
        }
            ...
            where T : IComparable<T>
        {
            ...
            string format = canEqual ? CoreRes.ParameterCheck_NotLessThanOrEqual : CoreRes.ParameterCheck_NotLessThan;
            ...
            bool endEqual = false) where T : IComparable<T>
        {
            ...
            string message = startEqual
                ? string.Format(CoreRes.ParameterCheck_Between, paramName, start, end)
                : string.Format(CoreRes.ParameterCheck_BetweenNotEqual, paramName, start, end, start);
            Require<ArgumentOutOfRangeException>(flag, message);

            flag = endEqual ? value.CompareTo(end) <= 0 : value.CompareTo(end) < 0;
            message = endEqual
                ? string.Format(CoreRes.ParameterCheck_Between, paramName, start, end)
                : string.Format(CoreRes.ParameterCheck_BetweenNotEqual, paramName, start, end, end);
            Require<ArgumentOutOfRangeException>(flag, message);
        }
        ...
        public static void NotNegativeOrZero(TimeSpan timeSpan, string paramName) =>
            Require<ArgumentOutOfRangeException>(timeSpan > TimeSpan.Zero, paramName);
        ...
        public static void DirectoryExists(string directory, string paramName = null)
        {
            ...
            Require<DirectoryNotFoundException>(Directory.Exists(directory),
                string.Format(CoreRes.ParameterCheck_DirectoryNotExists, directory));
        }
        ...
        public static void FileExists(string fileName, string paramName = null)
        {
            ...
            Require<FileNotFoundException>(System.IO.File.Exists(fileName),
                string.Format(CoreRes.ParameterCheck_FileNotExists, fileName));
        }
