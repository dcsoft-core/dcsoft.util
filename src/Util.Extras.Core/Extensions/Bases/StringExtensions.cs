...
namespace Util.Extras.Extensions
{
    ...
    public static partial class StringExtensions
    {
        ...
        public static string SubstringFrom(this string value, int index) => index < 0
            ? value
        ...
        {
            var sb = new StringBuilder(value);
            using var newValueEnum = newValues.GetEnumerator();
            foreach (var oldValue in oldValues)
            {
        ...
        public static string EncodeEmailAddress(this string emailAddress)
        {
            ...
            for (var i = tempHtmlEncode.Length; i >= 1; i--)
            {
        ...
        public static string ReplacePath(this string path)
        {
            if (string.IsNullOrWhiteSpace(path))
                return string.Empty;
            return Util.Helpers.Common.IsWindows ? path.Replace("/", "\\") : path.Replace("\\", "/");
        }
