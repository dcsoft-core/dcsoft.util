...
using Reflection = Util.Extras.Helpers.Reflection;
...
namespace Util.Extras.Extensions
{
    ...
    public static partial class Extensions
    {
        ...
        public static bool IsNullableType(this Type type) => type != null && type.IsGenericType &&
        ...
        public static bool IsNullableEnum(this Type type) =>
            Nullable.GetUnderlyingType(type)?.GetTypeInfo().IsEnum ?? false;
        ...
        public static bool HasAttribute<T>(this Type type, bool inherit = false) where T : Attribute =>
            type.GetTypeInfo().IsDefined(typeof(T), inherit);
        ...
        public static T GetAttribute<T>(this Type type, bool inherit = false) where T : Attribute =>
            type.GetTypeInfo().GetCustomAttributes<T>(inherit).FirstOrDefault();
        ...
        public static bool IsDeriveClassFrom<TBaseType>(this Type type, bool canAbstract = false) =>
            Reflection.IsDeriveClassFrom<TBaseType>(type, canAbstract);
        ...
        public static bool IsDeriveClassFrom(this Type type, Type baseType, bool canAbstract = false) =>
            Reflection.IsDeriveClassFrom(type, baseType, canAbstract);
        ...
        public static bool IsGenericAssignableFrom(this Type genericType, Type type) =>
            Reflection.IsGenericAssignableFrom(genericType, type);
        ...
        public static bool IsCollectionType(this Type type) =>
            type.GetInterfaces().Any(n => n.Name == nameof(IEnumerable));
