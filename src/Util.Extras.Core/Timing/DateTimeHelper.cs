...
namespace Util.Extras.Timing
{
    ...
    public class DateTimeHelper
    {
        ...
        public static string MinuteDateFormat(DateTime dt, string defaultFormat = "yyyy-MM-dd HH:mm:ss")
        {
        ...
        /// <param name="startDate">输出开始日期</param>
        /// <param name="endDate">输出结束日期</param>
        public static void GetDateRange(DateTime date, DateRangeEnum range, out DateTime startDate,
