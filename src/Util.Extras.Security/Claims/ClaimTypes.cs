namespace Util.Extras.Security.Claims
{
    /// <summary>
    /// 声明类型
    /// </summary>
    public static class ClaimTypes
    {
        ...
        /// 手机号
        /// </summary>
        public static string Mobile { get; set; } = "phone_number";

        /// <summary>
        /// 姓名
        /// </summary>
        public static string FullName { get; set; } = "family_name";
        ...
        /// 角色标识列表
        /// </summary>
        public static string RoleIds { get; set; } = "role";
