...
namespace Util.Extensions
{
    ...
    public static partial class StringExtensions
    {
        ...
        /// </summary>
        /// <param name="value">值</param>
        public static string ExtractLettersNumbers(this string value) => value
            .Where(x => !x.IsChinese() && char.IsLetterOrDigit(x))
        ...
        public static string Remove(this string value, params string[] strings) =>
            strings.Aggregate(value, (current, c) => current.Replace(c, string.Empty));
        ...
        public static string TrimToMaxLength(this string value, int maxLength) =>
            (value == null || value.Length <= maxLength ? value : value.Substring(0, maxLength));
        ...
        public static string EnsureStartsWith(this string value, string prefix) =>
            value.StartsWith(prefix) ? value : string.Concat(prefix, value);
        ...
        public static string EnsureEndWith(this string value, string suffix) =>
            value.EndsWith(suffix) ? value : string.Concat(value, suffix);
        ...
        public static string SubstringFrom(this string value, int index) => index < 0 && index < value.Length
            ? value
        ...
        public static string ToPlural(this string singular)
        {
            ...
            //单数形式单词规则
            //-es为后缀结束规则
            if (singular.EndsWith("sh") || singular.EndsWith("ch") || singular.EndsWith("us") ||
        ...
        public static string EncodeEmailAddress(this string emailAddress)
        {
            ...
            {
                int acode = System.Convert.ToInt32(tempHtmlEncode[i - 1]);
                string repl;
                switch (acode)
                {
                    case 32:
        ...
        public static string ReplacePath(this string path)
        {
            if (string.IsNullOrWhiteSpace(path))
                return string.Empty;
            return Common.IsWindows ? path.Replace("/", "\\") : path.Replace("\\", "/");
        }
        ...
        {
            return Helpers.String.RemoveStart(value, start);
        }
        ...
        {
            return Helpers.String.RemoveEnd(value, end);
        }
