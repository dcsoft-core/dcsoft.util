...
namespace Util.Extensions
{
    ...
    public static partial class StringExtensions
    {
        ...
        public static string[] RegexSplit(this string value, string pattern, RegexOptions options) =>
            Regex.Split(value, pattern, options);
        ...
        public static string ReplaceWith(this string value, string pattern, string replaceValue) =>
            value.ReplaceWith(pattern, replaceValue, RegexOptions.None);
        ...
        public static string
            ReplaceWith(this string value, string pattern, string replaceValue, RegexOptions options) =>
            Regex.Replace(value, pattern, replaceValue, options);
        ...
        public static string ReplaceWith(this string value, string pattern, MatchEvaluator evaluator) =>
            value.ReplaceWith(pattern, RegexOptions.None, evaluator);
