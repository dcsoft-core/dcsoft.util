...
namespace Util.Extensions
{
    ...
    public static partial class ObjectExtensions
    {
        ...
        public static int ClonePropertyFrom(this object destination, object source) =>
            destination.ClonePropertyFrom(source, null);
        ...
        /// <returns>成功复制的值个数</returns>
        public static int ClonePropertyFrom(this object @this, object source, Type type,
            IEnumerable<string> excludeName)
        {
        ...
        public static int ClonePropertyTo(this object source, object destination) =>
            source.ClonePropertyTo(destination, null);
