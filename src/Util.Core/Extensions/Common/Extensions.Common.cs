...
namespace Util.Extensions
{
    ...
    public static partial class Extensions
    {
        ...
        public static int? Value(this System.Enum instance) => Util.Helpers.Enum.GetValue(instance.GetType(), instance);
        ...
        public static TResult Value<TResult>(this System.Enum instance) =>
            Convert.To<TResult>(Value(instance));
        ...
        public static string Description(this System.Enum instance) =>
            Util.Helpers.Enum.GetDescription(instance.GetType(), instance);
        ...
        public static string Join<T>(this IEnumerable<T> list, string quotes = "", string separator = ",") =>
            Helpers.String.Join(list, quotes, separator);
