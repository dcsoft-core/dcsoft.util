...
namespace Util.Conversions.Scale
{
    /// <summary>
    /// 字节转换器
    /// </summary>
    public static class ByteConverter
    {
        ...
        public static string ToBinary(byte @byte) => DecimalConverter.ToBinary(@byte);
        ...
        public static int ToDecimal(byte h, byte l) => h << 8 | l;
        ...
        public static int ToDecimal(byte h, byte l, bool isRadix)
        {
            var v = (ushort) (h << 0 | l);
            if (isRadix && h > 127)
            {
