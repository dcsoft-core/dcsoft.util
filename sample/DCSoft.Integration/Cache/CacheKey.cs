...
namespace DCSoft.Integration.Cache
{
    ...
    public static class CacheKey
    {
        ...
        /// </summary>
        [Description("密码加密")] public const string PassWordEncryptKey = "admin:password:encrypt:{0}";

        /// <summary>
        /// 用户权限 admin:user:permissions:用户主键
        /// </summary>
        [Description("用户权限")] public const string UserPermissions = "admin:user:permissions:{0}";
    }
}